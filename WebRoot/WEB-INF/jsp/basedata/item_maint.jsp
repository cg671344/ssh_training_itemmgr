...
<form name="itemForm" id="itemForm">
  ...
  <table width="95%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="rd1">
    <tr> 
      <td  nowrap class="rd19" height="2" width="36%"> <div align="left"><font >&nbsp;<bean:message key="drp.page.totalPages"/>:&nbsp${pagemodel.totalPages }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font><bean:message key="drp.page.currentPage"/>:</font>&nbsp<font>${pagemodel.pageNo }</font>&nbsp<font></font> 
        </div></td>
      <td  nowrap class="rd19" width="64%"> <div align="right">
		...
		<p align="center">
			<a href="<%=request.getContextPath()%>/basedata/item.do?command=listDisplaytag">listDisplaytag</a>
		</p>
